...
?>
  <nav class="light-blue lighten-1" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo"></a>
      ...
      <a class="waves-effect waves-yellow btn" href="http://localhost/parallax-template/">about us</a>

        <!-- Dropdown Structure 1 -->
  <ul id='dropdown1' class='dropdown-content'>
    <li><a href="home_pegawai.php">Update Profil</a></li>
    <li class="divider"></li>
    <li><a href="logout.php">Logout</a></li>
  </ul>
  <!-- Dropdown Structure 2 -->
  <ul id='dropdown2' class='dropdown-content'>
    <li><a href="obat/home.php">Input Obat</a></li>
    <li class="divider"></li>
    <li><a href="jadwal_praktek/home.php">Input Jadwal Praktek</a></li>
    <li class="divider"></li>
    <li><a href="dokter/home.php">Input Dokter</a></li>
    <li class="divider"></li>
    <li><a href="jenis_biaya/home.php">Input Jenis Biaya</a></li>
    <li class="divider"></li>
    <li><a href="jadwal_praktek/home.php">Input Jadwal Praktek</a></li>
    <li class="divider"></li>
  </ul>
  ...
  <li><a href="pendaftaran/home.php">Input Pendaftaran</a></li>
    <li class="divider"></li>
    <li><a href="pemeriksaan/home.php">Input Pemeriksaan</a></li>
    <li class="divider"></li>
    <li><a href="pasien/home.php">Input Pasien</a></li>
    <li class="divider"></li>
    <li><a href="resep/home.php">Input Resep</a></li>
    <li class="divider"></li>
    <li><a href="poliklinik/home.php">Input Jenis Poli</a></li>
    <li class="divider"></li>
  </ul>
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Banyak Mendengar daripada Mengeluh</h5>

            <p class="light">Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. </p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Serasa di hotel Berbintang</h5>

            <p class="light">Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. </p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Pelayanan yang Keren</h5>

            <p class="light">Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. Ini hanya contoh tulisan. </p>
          </div>
        </div>
      </div>
